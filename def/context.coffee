...
Context:
  ...
  "atom-text-editor, .overlayer":
    ...
    "core:delete": "删除"
    "core:select-all": "全选"
    "pane:split-up-and-copy-active-item": "分屏分裂和复制 ↑"
    "pane:split-down-and-copy-active-item": "分屏分裂和复制 ↓"
    "pane:split-left-and-copy-active-item": "分屏分裂和复制 ←"
    "pane:split-right-and-copy-active-item": "分屏分裂和复制 →"
    "pane:close": "关闭分屏"
  "atom-pane":
    "pane:split-up-and-copy-active-item": "分屏拆分 ↑"
    "pane:split-down-and-copy-active-item": "分屏拆分 ↓"
    "pane:split-left-and-copy-active-item": "分屏拆分 ←"
    "pane:split-right-and-copy-active-item": "分屏拆分 →"
    "pane:close": "关闭分屏"
  ...
  ".tab":
    ...
    "tabs:split-up": "分屏拆分 ↑"
    "tabs:split-down": "分屏拆分 ↓"
    "tabs:split-left": "分屏拆分 ←"
    "tabs:split-right": "分屏拆分 →"
  ".tab.texteditor":
  ...
  '.tree-view .full-menu [is="tree-view-file"]':
    "tree-view:open-selected-entry-up": "分屏拆分 ↑"
    "tree-view:open-selected-entry-down": "分屏拆分 ↓"
    "tree-view:open-selected-entry-left": "分屏拆分 ←"
    "tree-view:open-selected-entry-right": "分屏拆分 →"
